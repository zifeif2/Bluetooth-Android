...
public class MainActivity extends Activity {
    ...
    private void say(String word) {
        if( mAcceptThread != null) {//are you a server?
            try {
        ...
        else if( mConnectThread != null) {//are you a client?
            try {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constant.MSG_GOT_DATA:
                    tmp+=String.valueOf(msg.obj);
                    Log.e("DATA_TMP" , String.valueOf(msg.obj));
                ...
                case Constant.MSG_ERROR:
                    mTextView.setText(String.valueOf(msg.obj));
                    Log.e("MainActivity", "error: "+String.valueOf(msg.obj));
                    break;
